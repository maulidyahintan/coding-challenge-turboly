...
export default async function DashboardPage() {
  ...
  return (
    <main className="flex h-screen flex-col gap-4 bg-linear-to-b from-sky-700 via-sky-600 to-sky-500 px-3 py-4 sm:px-5 sm:py-6">
      <nav className="relative z-50 mx-auto hidden w-full items-center justify-between gap-3 rounded-2xl border border-sky-300/30 bg-sky-900/35 px-4 py-3 backdrop-blur-sm md:flex lg:hidden sm:px-5">
        <div>
          <p className="text-xs font-semibold uppercase tracking-[0.2em] text-sky-100/80">
            Turboly Challenge
          </p>
          <h1 className="text-xl font-semibold text-white">Tablet Workspace</h1>
        </div>
